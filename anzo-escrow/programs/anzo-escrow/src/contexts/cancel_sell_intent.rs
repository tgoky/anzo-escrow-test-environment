...
pub struct CancelSellIntent<'info> {
    #[account(
    ...
    #[account(
        ...
        bump,
        constraint = offer.maker_authority == maker_authority.key(),
    )]
...
pub(crate) fn handler(ctx: Context<CancelSellIntent>, intent_id: u64, _offer_id: u64) -> Result<()> {
